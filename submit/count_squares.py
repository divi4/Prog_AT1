def main():
    ...
    print("Number of squares in {}: {} squares".format(string, count_squares(string)))


def count_squares(s):
    num_squares = 0

    for search_group in range(1, (len(s)//2)):  # Search group number tells function the character size of each group it'll compare in the iteration
